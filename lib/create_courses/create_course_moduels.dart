...
class _CreateCoursePage3State extends State<CreateCoursePage3> {
  ...
  Future<void> _fetchCourseData() async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycreations/create/$_courseSlug/';
  ...
  Future<void> _fetchModules() async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycreations/create/$_courseSlug/modules/';
    print('Fetching modules from: $url');
  ...
  Future<void> _deleteModule(String moduleId) async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycreations/create/$_courseSlug/modules/$moduleId';
