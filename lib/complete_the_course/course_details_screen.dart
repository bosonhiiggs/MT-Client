...
class _CourseDetailsScreenState extends State<CourseDetailsScreen> {
  ...
  Future<void> _fetchModules() async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycourses/${widget.course.slug}/modules/';
  ...
  Future<void> _fetchLessonsForModule(Module module) async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycourses/${widget.course.slug}/modules/${module.id}/';
  ...
  Future<void> _fetchComments() async {
    ...
    final url = 'http://10.0.2.2:8000/api/mycourses/${widget.course.slug}/';
  ...
  Future<void> _submitComment() async {
    ...
    // Construct the URL
    final url = 'http://10.0.2.2:8000/api/mycourses/${widget.course.slug}/review-post/';
