...
class _LessonContentScreenState extends State<LessonContentScreen> {
  ...
  Future<void> _loadPreferences() async {
    try {
      ...
      final url = 'http://10.0.2.2:8000/api/mycourses/${widget
  ...
  Future<void> _loadFileContent(int contentId) async {
    try {
      ...
      final url = 'http://10.0.2.2:8000/api/mycourses/${widget.courseSlug}/modules/${widget.moduleId}/${widget.lessonId}/$contentId/';
  ...
  Future<void> _checkFileExistence(int currentContentId) async {
    try {
      ...
      final response = await http.get(
          Uri.parse('http://10.0.2.2:8000/api/mycourses/${widget
  ...
  Future<void> _checkReview(int currentContentId, Map<String, String> headers) async {
    try {
      final reviewResponse = await http.get(
        Uri.parse('http://10.0.2.2:8000/api/mycourses/${widget.courseSlug}/modules/${widget.moduleId}/${widget.lessonId}/$currentContentId/submission/review'),
        headers: headers,
      );
  ...
  Future<void> _submitComment(int contentId, String type) async {
    ...
    // Construct the URL
    final url = 'http://10.0.2.2:8000/api/mycourses/${widget.courseSlug}/modules/${widget.moduleId}/${widget.lessonId}/$contentId/comments/';
    print(url);
